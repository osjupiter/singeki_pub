...
void Images::load(){
	...
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/•P‹Rmw3.png", ANI_HIME_W, ANI_HIME_W, 1, WID_HIME_W, HEI_HIME, g_hime_w);
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/•P‹Rma3.png", ANI_HIME_A, ANI_HIME_A, 1, WID_HIME_A, HEI_HIME, g_hime_a);
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/•P‹RmƒI[ƒ‰.png", ANI_HIME_O, ANI_HIME_O, 1, WID_HIME_O, HEI_HIME_O, g_hime_o);
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/•P‹Rmƒ`ƒƒ[ƒW.png", ANI_HIME_C, ANI_HIME_C, 1, WID_HIME_C, HEI_HIME_C, g_hime_c);
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/•P‹RmUŒ‚I—¹.png", ANI_HIME_AE, ANI_HIME_AE, 1, WID_HIME_AE, HEI_HIME_AE, g_hime_ae);
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/‘åO•ó‹ï.png", ANI_HIME_H, 1,ANI_HIME_H, WID_HIME_H, HEI_HIME_H, g_hime_h);
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/•P‹Rm‚Ä‚±“ü‚ê/‘åO•ó‹ï”­“®’†.png", ANI_HIME_HC, ANI_HIME_HC, 1, WID_HIME_HC, HEI_HIME_HC, g_hime_hc);
	...
	LoadDivGraph("dat/img/‚Ş‚·‚ßƒ†ƒjƒbƒg/–‚—‚Ä‚±“ü‚ê/–‚—ƒ\ƒEƒ‹‚Ì–î.png", ANI_MAHOU, 5, 2, WID_MAHOU, HEI_MAHOU, g_mahou);
	...
	LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/…‚Ì’†/“ä‚ÌGè‚PoŒ».png", ANI_SHOKUSH_S, 5, 3, WID_SHOKUSH, HEI_SHOKUSH, g_shokush_s[0]);
...
*/
	...
	void Images::loadStage(int sid){
		...
		case 2:
			...
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/‰_‚Ìã/ˆÙŠE‚Ì–å‘Ò‹@.png", ANI_IKAI_W, 4, 1, WID_IKAI, HEI_IKAI, g_ikai_w);
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/‰_‚Ìã/ˆÙŠE‚Ì–åUŒ‚1.png", ANI_IKAI_A1, 3, 1, WID_IKAI, HEI_IKAI, g_ikai_a1);
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/‰_‚Ìã/ˆÙŠE‚Ì–åUŒ‚2.png", ANI_IKAI_A2, 4, 1, WID_IKAI, HEI_IKAI, g_ikai_a2);

			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/‰_‚Ìã/‚²‚İ1.png", ANI_GOMI, 6, 2, WID_GOMI, HEI_GOMI, g_gomi[0]);
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/‰_‚Ìã/‚²‚İ2.png", ANI_GOMI, 6, 2, WID_GOMI, HEI_GOMI, g_gomi[1]);
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/‰_‚Ìã/‚²‚İ3.png", ANI_GOMI, 6, 2, WID_GOMI, HEI_GOMI, g_gomi[2]);
		...
		case 3:
			...
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/…‚Ì’†/…’ê‚Ì‹ô‘œ‘Ò‹@.png", ANI_GUUZOU_W, 4, 1, WID_GUUZOU, HEI_GUUZOU, g_guuzou_w);
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/…‚Ì’†/…’ê‚Ì‹ô‘œUŒ‚1.png", ANI_GUUZOU_A, 2, 1, WID_GUUZOU, HEI_GUUZOU, g_guuzou_a1);
			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/…‚Ì’†/…’ê‚Ì‹ô‘œUŒ‚2.png", ANI_GUUZOU_A, 2, 1, WID_GUUZOU, HEI_GUUZOU, g_guuzou_a2);

			LoadDivGraph("dat/img/“Gƒ†ƒjƒbƒg/…‚Ì’†/‹ô‘œ‚ÌŒõ.png", ANI_GLIGHT, 4, 1, WID_GLIGHT, HEI_GLIGHT, g_glight);
