...
//	gs[0]=LoadGraph("pic/test.jpg");
	...
	LoadDivGraph("dat/img/íÔ€–S.png", ANI_TANK_DEL,1, ANI_TANK_DEL, WID_TANK_DEL, HEI_TANK_DEL, g_tank_dei);
	...
	filelist.push_back("pic/ƒƒJ“´ŒAé2a.png");
	...
	filelist.push_back("pic/ƒƒJ‘Œ´é2.png");
