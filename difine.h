...
enum UnitType{_NONE,_HOHEI,_BALOON,_BIG,_KAMIKAZE,_BAZOOKA,_SEGWAY,_YOUJO,_TATEKO,_HIME,_IKAROS,_MAJO,_NOUKA,END_MUSUME,_TANK,_COPTER,_GEKKO,_RAILGUN,UNITTYPE_NUM};
