...
enum EffectType{ BOMB = 20, EXP, SHOCK, MISSILE, TEPODON, BEAM, BIGEXP, NOMALEXP, GUNSHOT, CANNONSHOT, DROP, WISP, HANA, YUKIDAMA, GVOICE, MONOBEAM,GYORAI,KIRAKIRA };
...
#define WID_MONORIS 200
#define HEI_MONORIS 400 
*/
#define ANI_MONORIS_W 11
#define ANI_MONORIS_A1 8
#define ANI_MONORIS_A2 3
